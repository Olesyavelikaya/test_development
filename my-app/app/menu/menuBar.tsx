...
export default function MenuBar() {
  ...
  return (
    <>
      <nav className="flex  font-medium text-sm leading-22 pt-8 md:pt-0">
        <div className="flex justify-between gap-4 overflow-x-auto whitespace-nowrap">
          <Link
            href="/my-info/personal"
            className={`px-4 flex-shrink-0 py-4 w-[90px] h-12 flex items-center justify-center rounded-t-lg ${linkStyle(
              "/personal",
            )}`}
          >
            Personal
